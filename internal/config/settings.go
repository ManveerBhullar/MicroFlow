...
var optionValidators = map[string]optionValidator{
	...
	"llm.debounce":            validateNonNegativeValue,
	"llm.edittokens":          validateNonNegativeValue,
	"llm.latencybudget":       validateNonNegativeValue,
	"llm.maxtokens":           validateNonNegativeValue,
	"llm.maxinputchars":       validateNonNegativeValue,
	"llm.maxsuffixpercentage": validateNonNegativeValue,
	"llm.promptmode":          validateChoice,
	"llm.timeout":             validateNonNegativeValue,
...
var DefaultGlobalOnlySettings = map[string]any{
	...
	"llm.promptmode":          "chat",
	"llm.disablefiletypes":    "markdown,txt,help,unknown",
	"llm.debug":               false,
	"llm.contextlines":        float64(120),
	"llm.maxinputchars":       float64(4096),
	"llm.maxsuffixpercentage": float64(0.35),
	"llm.debounce":            float64(500),
	"llm.edittokens":          float64(4096),
	"llm.maxtokens":           float64(128),
	"llm.timeout":             float64(120),
	"llm.latencybudget":       float64(5000),
	"lockbindings":            false,
	"mouse":                   true,
	"multiopen":               "tab",
	"parsecursor":             false,
